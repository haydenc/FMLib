FMErrorLookup = {
    -1: 'Unknown error', 0: 'No error (success)',
    1: 'User canceled action', 2: 'Memory error',
    ...
    6: 'File is read-only', 7: 'Running out of memory', 8: 'Empty result', 9: 'Insufficient privileges',
    10: 'Requested data is missing', 11: 'Name is not valid', 12: 'Name already exists',
    13: 'File or object is in use', 14: 'Out of range', 15: "Can't divide by zero",
    ...
    19: 'String contains characters other than A-Z, a-z, 0-9 (ASCII)', 100: 'File is missing',
    101: 'Record is missing', 102: 'Field is missing', 103: 'Relationship is missing',
    104: 'Script is missing', 105: 'Layout is missing', 106: 'Table is missing', 107: 'Index is missing',
    108: 'Value list is missing', 109: 'Privilege set is missing', 110: 'Related tables are missing',
    111: 'Field repetition is invalid', 112: 'Window is missing', 113: 'Function is missing',
    114: 'File reference is missing', 130: 'Files are damaged or missing and must be reinstalled',
    131: 'Language pack files are missing (such as template files)', 200: 'Record access is denied',
    201: 'Field cannot be modified', 202: 'Field access is denied',
    ...
    209: 'New password must be different from existing one', 210: 'User account is inactive',
    211: 'Password has expired', 212: 'Invalid user account and/or password. Please try again',
    213: 'User account and/or password does not exist', 214: 'Too many login attempts',
    215: 'Administrator privileges cannot be duplicated', 216: 'Guest account cannot be duplicated',
    217: 'User does not have sufficient privileges to modify administrator account',
    300: 'The file is locked or in use', 301: 'Record is in use by another user',
    302: 'Script definitions are in use by another user', 303: 'Paper size is in use by another user',
    304: 'Password definitions are in use by another user',
    305: 'Relationship or value list definitions are in use by another user',
    306: 'Record modification ID does not match', 400: 'Find criteria is empty',
    401: 'No records match the request', 402: 'Selected field is not a match field for a lookup',
    403: 'Exceeding maximum record limit for trial version of FileMaker Pro', 404: 'Sort order is invalid',
    ...
    408: 'Specified field has inappropriate data type for this operation', 409: 'Import order is invalid',
    410: 'Export order is invalid', 411: 'Cannot perform delete because related records cannot be deleted',
    412: 'Wrong version of FileMaker Pro used to recover file',
    413: 'Specified field has inappropriate field type', 414: 'Layout cannot display the result',
    ...
    508: 'Invalid value entered in Find mode', 509: 'Field requires a valid value',
    510: 'Related value is empty or unavailable',
    511: 'Value in field exceeds maximum number of allowed characters', 600: 'Print error has occurred',
    601: 'Combined header and footer exceed one page',
    602: 'Body doesn\'t fit on a page for current column setup', 603: 'Print connection lost',
    ...
    705: 'Data Access Manager failed when executing a query', 706: 'EPSF file has no preview image',
    ...
    711: 'Import translator can not be found', 712: 'XTND version is incompatible',
    713: 'Couldn\'t initialize the XTND system', 714: 'Password privileges do not allow the operation',
    ...
    722: 'Cannot import data into a file that has no fiel',
    ...
    733: 'A table cannot be imported into itself', 734: 'This file type cannot be displayed as a picture',
    735: 'This file type cannot be displayed as a picture. It will be inserted and displayed as a file',
    800: 'Unable to create file on disk', 801: 'Unable to create temporary file on System disk',
    802: 'Unable to open file', 803: 'File is single user or host cannot be found',
    ...
    808: 'Cannot open file because access privileges are damaged', 809: 'Disk/volume is full',
    810: 'Disk/volume is locked', 811: 'Temporary file cannot be opened as FileMaker Pro file',
    812: 'Cannot open the file because it exceeds host capacity',
    813: 'Record Synchronization error on network',
    814: 'File(s) cannot be opened because maximum number is open', 815: 'Couldn\'t open lookup file',
    816: 'Unable to convert file', 817: 'Unable to open file because it does not belong to this solution',
    818: 'FileMaker Pro cannot network for some reason', 819: 'Cannot save a local copy of a remote file',
    820: 'File is in the process of being closed', 821: 'Host forced a disconnect',
    822: 'FMI files not found; reinstall missing files',
    823: 'Cannot set file to single-user, guests are connected',
    824: 'File is damaged or not a FileMaker file', 900: 'General spelling engine error',
    901: 'Main spelling dictionary not installed', 902: 'Could not launch the Help system',
    ...
    950: 'Adding repeating related fields is not supported', 951: 'An unexpected error occurred',
    952: 'Mail format not found (Web Companion)', 953: 'Mail value missing (Web Companion)',
    954: 'Unsupported XML grammar', 955: 'No database name',
    956: 'Maximum number of database sessions exceeded', 957: 'Conflicting commands',
    958: 'Parameter missing in query', 971: 'The user name is invalid', 972: 'The password is invalid',
    973: 'The database is invalid', 974: 'Permission Denied', 975: 'The field has restricted access',
    976: 'Security is disabled', 977: 'Invalid client IP address',
